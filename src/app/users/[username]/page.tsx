...
import { chartConfig } from "@/shared/components/ui/ChartPieDonutText";
import {
  HoverCard,
  HoverCardContent,
  HoverCardTrigger,
        ...
        <div className="w-full xl:w-2/3 space-y-6">
          ...
          <div className="bg-primary-foreground p-4 rounded-lg space-y-2">
            ...
            <p className="text-sm text-muted-foreground">
              ...
              totam facilis ullam nam, consequuntur minima! Labore, error quod.
              Quibusdam harum sint incidunt iste necessitatibus, nihil quasi.
              Nulla blanditiis omnis consectetur!
            </p>
          </div>
          {/* CHART CONTAINER */}
          <div className="bg-primary-foreground p-4 rounded-lg">
